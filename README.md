...
* [xpartition](https://github.com/spencerkclark/xpartition) ⭐ 31 | 🐛 4 | 🌐 Python | 📅 2026-07-31: writing large xarray datasets to Zarr. Works around shortcomings of Dask ([distributed#6360](https://github.com/dask/distributed/issues/6360) ⭐ 1,692 | 🐛 1,520 | 🌐 Python | 📅 2026-09-19)
...
* [numcodecs](https://github.com/zarr-developers/numcodecs) ⭐ 150 | 🐛 130 | 🌐 Python | 📅 2026-09-18: Compression and transformation codecs used by Zarr
...
* [Neuroglancer](https://github.com/google/neuroglancer) ⭐ 1,517 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-17: WebGL-based viewer for volumetric data
...
* [stac-spec#781: Zarr Extension?](https://github.com/radiantearth/stac-spec/issues/781) ⭐ 931 | 🐛 50 | 🌐 JavaScript | 📅 2026-08-26
