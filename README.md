...
* [xpublish](https://github.com/xpublish-community/xpublish) ⭐ 209 | 🐛 28 | 🌐 Python | 📅 2026-09-14: Exposing as and consuming Zarr through a REST API
  * See also routers at [xpublish-community](https://github.com/xpublish-community), e.g. [xpublish-opendap](https://github.com/xpublish-community/xpublish-opendap) ⭐ 8 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-14
...
* [KivkIO](https://github.com/rapidsai/kvikio/) ⭐ 280 | 🐛 78 | 🌐 C++ | 📅 2026-09-18: C++ and Python bindings to [cuFile](https://docs.nvidia.com/gpudirect-storage/api-reference-guide/index.html), enabling [GPUDirect Storage](https://developer.nvidia.com/blog/gpudirect-storage/)
* [rechunker](https://github.com/pangeo-data/rechunker) ⭐ 180 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-09-14: disk-to-disk transformation for chunked arrays
...
* [xpartition](https://github.com/spencerkclark/xpartition) ⭐ 31 | 🐛 4 | 🌐 Python | 📅 2026-07-31: writing large xarray datasets to Zarr. Works around shortcomings of Dask ([distributed#6360](https://github.com/dask/distributed/issues/6360) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-21)
...
* [numcodecs](https://github.com/zarr-developers/numcodecs) ⭐ 150 | 🐛 129 | 🌐 Python | 📅 2026-09-18: Compression and transformation codecs used by Zarr
...
In the future, Kerchunk will be split into upstream functionality in Zarr itself and a new [VirtualiZarr](https://github.com/TomNicholas/VirtualiZarr) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-18 package.

* [Kerchunk JSON references](https://fsspec.github.io/kerchunk/spec.html) will become a part of the [Chunk manifest](https://github.com/zarr-developers/zarr-specs/issues/287) ⭐ 111 | 🐛 136 | 📅 2026-09-21
...
* [ome-zarr-py](https://github.com/ome/ome-zarr-py) ⭐ 258 | 🐛 81 | 🌐 Python | 📅 2026-09-21: Implementation of next-generation file format ([NGFF](https://ngff.openmicroscopy.org/)) specifications for storing bioimaging data in the cloud.
* [ez\_zarr](https://github.com/fmicompbio/ez_zarr) ⭐ 24 | 🐛 3 | 🌐 Python | 📅 2025-09-22: Easy, high-level access to OME-Zarr filesets
* [hdmf-zarr](https://github.com/hdmf-dev/hdmf-zarr) ⭐ 10 | 🐛 34 | 🌐 Python | 📅 2026-09-21: Zarr I/O backend for [HDMF](https://hdmf.readthedocs.io/en/stable/)
...
* [Neuroglancer](https://github.com/google/neuroglancer) ⭐ 1,525 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-17: WebGL-based viewer for volumetric data
...
* [n5](https://github.com/saalfeldlab/n5) ⭐ 209 | 🐛 29 | 🌐 Java | 📅 2026-08-31
* [z5](https://github.com/constantinpape/z5) ⭐ 135 | 🐛 25 | 🌐 C++ | 📅 2026-07-02: C++ and Python interface for datasets in zarr and n5 format
* [Zarr N5 spec diff (zarr-specs#3)](https://github.com/zarr-developers/zarr-specs/issues/3) ⭐ 111 | 🐛 136 | 📅 2026-09-21
...
* [Specs](https://github.com/zarr-developers/geozarr-spec) ⭐ 213 | 🐛 37 | 🌐 HTML | 📅 2026-08-03
...
* [stac-spec#781: Zarr Extension?](https://github.com/radiantearth/stac-spec/issues/781) ⭐ 932 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-26
* [geozarr-spec#32: Integration of Zarr with STAC Catalogs](https://github.com/zarr-developers/geozarr-spec/issues/32) ⭐ 213 | 🐛 37 | 🌐 HTML | 📅 2026-08-03
