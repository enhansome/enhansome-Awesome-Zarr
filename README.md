...
* [xpublish](https://github.com/xpublish-community/xpublish) ⭐ 209 | 🐛 29 | 🌐 Python | 📅 2026-09-21: Exposing as and consuming Zarr through a REST API
  * See also routers at [xpublish-community](https://github.com/xpublish-community), e.g. [xpublish-opendap](https://github.com/xpublish-community/xpublish-opendap) ⭐ 8 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-21
...
* [xpartition](https://github.com/spencerkclark/xpartition) ⭐ 31 | 🐛 4 | 🌐 Python | 📅 2026-07-31: writing large xarray datasets to Zarr. Works around shortcomings of Dask ([distributed#6360](https://github.com/dask/distributed/issues/6360) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-22)
...
* [Kerchunk JSON references](https://fsspec.github.io/kerchunk/spec.html) will become a part of the [Chunk manifest](https://github.com/zarr-developers/zarr-specs/issues/287) ⭐ 111 | 🐛 136 | 📅 2026-09-22
...
* [ome-zarr-py](https://github.com/ome/ome-zarr-py) ⭐ 258 | 🐛 84 | 🌐 Python | 📅 2026-09-22: Implementation of next-generation file format ([NGFF](https://ngff.openmicroscopy.org/)) specifications for storing bioimaging data in the cloud.
* [ez\_zarr](https://github.com/fmicompbio/ez_zarr) ⭐ 24 | 🐛 3 | 🌐 Python | 📅 2025-09-22: Easy, high-level access to OME-Zarr filesets
* [hdmf-zarr](https://github.com/hdmf-dev/hdmf-zarr) ⭐ 10 | 🐛 27 | 🌐 Python | 📅 2026-09-22: Zarr I/O backend for [HDMF](https://hdmf.readthedocs.io/en/stable/)
...
* [Neuroglancer](https://github.com/google/neuroglancer) ⭐ 1,528 | 🐛 235 | 🌐 TypeScript | 📅 2026-09-22: WebGL-based viewer for volumetric data
* [Vizarr](https://github.com/hms-dbmi/vizarr) ⭐ 199 | 🐛 48 | 🌐 TypeScript | 📅 2026-06-22: interactive viewer built using [viv](https://github.com/hms-dbmi/viv) ⭐ 362 | 🐛 75 | 🌐 JavaScript | 📅 2026-09-10 (OME-Zarr and OME-TIFF)
...
* [n5](https://github.com/saalfeldlab/n5) ⭐ 210 | 🐛 29 | 🌐 Java | 📅 2026-08-31
* [z5](https://github.com/constantinpape/z5) ⭐ 135 | 🐛 25 | 🌐 C++ | 📅 2026-07-02: C++ and Python interface for datasets in zarr and n5 format
* [Zarr N5 spec diff (zarr-specs#3)](https://github.com/zarr-developers/zarr-specs/issues/3) ⭐ 111 | 🐛 136 | 📅 2026-09-22
